package com.crush.thecrushmanager.service;
...
public class MyUploadService extends MyBaseTaskService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_UPLOAD.equals(intent.getAction())) {
            ...
            String dirName = intent.getStringExtra(EXTRA_DIR_NAME);
            uploadFromUri(fileUri, dirName);
        }
    ...
    private void uploadFromUri(final Uri fileUri, String dirName) {
        ...
        final StorageReference photoRef = mStorageRef.child(dirName)
